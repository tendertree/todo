				...
				<form onSubmit={handleSubmit}>
					...
					<div className="flex flex-row items-center justify-center mt-10 ">
						<input
							...
							name="todo"
							required
							className="mb-6 w-40 sm:w-80 ml-10 bg-gray-100 border border-gray-300 text-black text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
						/>
						<button
							type="submit"
